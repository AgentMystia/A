...
export async function install(input: Target & {
    apkPath: string;
}): Promise<{
    installed: boolean;
    serial: string;
...
export async function launch(input: Target & {
...
export async function terminate(input: Target & {
    applicationId: string;
}): Promise<{
    terminated: boolean;
    serial: string;
...
export async function openUrl(input: Target & {
    url: string;
}): Promise<{
    opened: boolean;
    serial: string;
