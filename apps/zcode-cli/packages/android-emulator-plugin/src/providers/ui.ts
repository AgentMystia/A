...
export async function describe(input: UiTarget = {}): Promise<{
...
export async function resolve(input: UiTarget & {
    query: string;
}): Promise<{
    device: import("./device.js").Device;
    element: UiElement;
...
export async function tap(input: UiTarget & {
    x: number;
    y: number;
}): Promise<{
    tapped: boolean;
...
export async function swipe(input: UiTarget & {
    x1: number;
    y1: number;
    x2: number;
    y2: number;
...
export async function typeText(input: UiTarget & {
    text: string;
}): Promise<{
    typed: boolean;
    serial: string;
...
export async function keyevent(input: UiTarget & {
