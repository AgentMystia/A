...
export async function tap(input: Tap): Promise<{
    backend: string;
    udid: string;
    output: string;
}> {
...
export async function swipe(input: Swipe): Promise<{
    backend: string;
    udid: string;
    output: string;
}> {
...
export async function typeText(input: Text): Promise<{
    backend: string;
    udid: string;
    output: string;
}> {
...
export async function button(input: Button): Promise<{
    backend: string;
    udid: string;
    output: string;
}> {
...
export async function describe(input: Target = {}): Promise<{
    backend: string;
    udid: string;
    output: string;
}> {
